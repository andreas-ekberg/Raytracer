...
int main()
{
    ...
    Polygon::polygons.push_back(new Rectangle(glm::dvec3(7, 4, 3), glm::dvec3(7, 5, 3), glm::dvec3(6, 4, 3), glm::dvec3(6, 5, 3), color(0.2, 0.8, 0.2), Lamb));

    Polygon::polygons.push_back(new Rectangle(glm::dvec3(0, 6, 5), glm::dvec3(10, 6, 5), glm::dvec3(0, -6, 5), glm::dvec3(10, -6, 5), color(0.8, 0.2, 0.2), Lamb));
